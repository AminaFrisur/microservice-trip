...
#[wasm_bindgen(module = "/CircuitBrekaer.js")]
extern "C" {
...
#[wasm_bindgen(module = "/httpClient.js")]
extern "C" {
     pub type HttpClient;
}
...
impl Cache   {
    ...
    #[wasm_bindgen(method)]
    pub async fn check_and_get_booking_in_cache(&mut self, login_name: &str, auth_token: &str, buchungsnummer: i32, circuit_breaker: CircuitBreaker, httpClient: HttpClient) -> Booking {
        // let mut booking_found = false;
        ...
        if booking_index_i32 >= 0 {
            ...
            match circuit_breaker.circuit_breaker_post_request(addr_with_params, login_name.to_string(), auth_token.to_string(), "GET".to_string(), httpClient).await {
              Ok(res) => {
